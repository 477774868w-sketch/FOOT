...
**Ce qui n'est pas promis :** un suivi s'arrête si le serveur s'arrête, et la
page le dit. Sans source de compositions active, la boucle tourne sans rien
lire — la fiche l'écrit aussi.
...
| Suivi qui survit au **redémarrage du serveur** | — | **non développé** |
